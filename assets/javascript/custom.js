...
function typewriter(){
    if ($("#typewriter").length) {
        ...
        typewriter.typeString('The Future of the Web').pauseFor(2000).deleteAll()
            .typeString('Engaging Experiences').pauseFor(2000).deleteAll()
            .typeString('Apps That Tell Your Story').pauseFor(2000).start();
    }
}
